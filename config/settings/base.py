"""
Base settings for UnFold project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'unfold.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Sweyn Venderbush""", 'sweyn.venderbush@yale.edu'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///unfold'),
}
...
ACCOUNT_ADAPTER = 'unfold.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'unfold.users.adapters.SocialAccountAdapter'
